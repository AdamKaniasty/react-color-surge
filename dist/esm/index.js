...
var findDominantColor = function (pixelArray) {
    var colorFrequency = {};
    var totalRed = 0;
    var totalGreen = 0;
    var totalBlue = 0;
    ...
    var avgRed = Math.round(totalRed / totalPixels);
    var avgGreen = Math.round(totalGreen / totalPixels);
    var avgBlue = Math.round(totalBlue / totalPixels);
...
var Color = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement("img", __assign({}, rest, { id: 'color-surge-img' + id, ref: imgRef, onLoad: function () { return setImgLoaded(true); } }))));
};
